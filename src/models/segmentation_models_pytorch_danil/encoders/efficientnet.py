...
from efficientnet_pytorch.utils import url_map, get_model_params, relu_fn
...
class EfficientNetEncoder(EfficientNet):
    def __init__(self, skip_connections, model_name):
        ...
        # self._conv_stem.in_channels = 2
        # self.conv0 = nn.Conv2d(2, 3, kernel_size=3, stride=2, bias=False)
        del self._fc
